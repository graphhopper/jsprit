...
It is lightweight, flexible and easy-to-use, and based on a single all-purpose [meta-heuristic]([../docs/Meta-Heuristic.md](https://github.com/graphhopper/jsprit/blob/master/docs/Meta-Heuristic.md)) currently solving
