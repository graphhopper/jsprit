 ...
 * Tests skill updater
 */
@DisplayName("Update Required Skills Test")
class UpdateRequiredSkillsTest {
    ...
    void doBefore() {
        ...
        VehicleRoutingProblem vrp = VehicleRoutingProblem.Builder.newInstance().addVehicle(vehicle).addJob(service).addJob(service2).addJob(service3).build();
    ...
    @Test
    @DisplayName("When Updating Route _ skills At Route Level Should Contain All Skills")
