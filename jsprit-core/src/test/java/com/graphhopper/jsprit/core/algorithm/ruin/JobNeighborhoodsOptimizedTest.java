...
@DisplayName("Job Neighborhoods Optimized Test")
class JobNeighborhoodsOptimizedTest {
    ...
    @Test
    @DisplayName("When Requesting Neighborhood Of Target Job _ neighbors Should Be Correct")
    void whenRequestingNeighborhoodOfTargetJob_neighborsShouldBeCorrect() {
        JobNeighborhoodsOptimized jn = new JobNeighborhoodsOptimized(vrp, jobDistance, 4);
        jn.initialise();
    ...
    @Test
    @DisplayName("When Requesting Neighbors For Zero Index Break _ it Should Return Empty Iterator")
    void whenRequestingNeighborsForZeroIndexBreak_itShouldReturnEmptyIterator() {
        JobNeighborhoodsOptimized jn = new JobNeighborhoodsOptimized(vrp, jobDistance, 2);
        jn.initialise();
