...
@DisplayName("Job Neighborhoods Impl Test")
class JobNeighborhoodsImplTest {
    ...
    @Test
    @DisplayName("When Requesting Neighborhood Of Target Job _ it Should Returnthe Max Distance")
