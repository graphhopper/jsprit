...
class LoadStateTest {
    ...
    @Test
    @DisplayName("Load At End Should Be 15")
    ...
    @Test
    @DisplayName("Load At Beginning Should Be 0")
    ...
    @Test
    @DisplayName("Load At Act 1 Should Be 10")
    ...
    @Test
    @DisplayName("Load At Act 2 Should Be 15")
    ...
    @Test
    @DisplayName("Future Max Loat At Act 1 Should Be 15")
    ...
    @Test
    @DisplayName("Future Max Loat At Act 2 Should Be 15")
    ...
    @Test
    @DisplayName("Past Max Loat At Act 1 Should Be 0")
    ...
    @Test
    @DisplayName("Past Max Loat At Act 2 Should Be 10")
     ...
     */
    @Test
    @DisplayName("When _ pdroute _ load At End Should Be 10")
    ...
    @Test
    @DisplayName("When _ pdroute _ load At Beginning Should Be 5")
    ...
    @Test
    @DisplayName("When _ pdroute _ load At Act 1 Should Be 15")
    ...
    @Test
    @DisplayName("When _ pdroute _ load At Act 2 Should Be 10")
    ...
    @Test
    @DisplayName("When _ pdroute _ future Max Loat At Act 1 Should Be 15")
    ...
    @Test
    @DisplayName("When _ pdroute _ future Max Loat At Act 2 Should Be 10")
    ...
    @Test
    @DisplayName("When _ pdroute _ past Max Loat At Act 1 Should Be 15")
    ...
    @Test
    @DisplayName("When _ pdroute _ past Max Loat At Act 2 Should Be 10")
     ...
     */
    @Test
    @DisplayName("When _ shipmentroute _ load At End Should Be 0")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ load At Beginning Should Be 0")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ load At Act 1 Should Be 10")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ load At Act 2 Should Be 15")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ load At Act 3 Should Be 10")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ load At Act 4 Should Be 0")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ future Max Loat At Act 1 Should Be 15")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ future Max Loat At Act 2 Should Be 15")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ future Max Loat At Act 3 Should Be 10")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ future Max Loat At Act 4 Should Be 0")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ past Max Loat At Act 1 Should Be 10")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ past Max Loat At Act 2 Should Be 10")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ past Max Loat At Act 3 Should Be 15")
    ...
    @Test
    @DisplayName("When _ shipmentroute _ past Max Loat At Act 4 Should Be 15")
