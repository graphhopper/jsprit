...
@DisplayName("Job Insertion Considering Fix Costs Calculator Test")
class JobInsertionConsideringFixCostsCalculatorTest {
    ...
    @Test
    @DisplayName("When Old Vehicle Is Null And Solution Complete _ it Should Return Fixed Costs Of New Vehicle")
    void whenOldVehicleIsNullAndSolutionComplete_itShouldReturnFixedCostsOfNewVehicle() {
    ...
    @Test
    @DisplayName("When Old Vehicle Is Null And Solution Is 0 Percent Complete _ it Should Return No Fixed Costs")
    void whenOldVehicleIsNullAndSolutionIs0PercentComplete_itShouldReturnNoFixedCosts() {
    ...
    @Test
    @DisplayName("When Old Vehicle Is Null And Solution Is 50 Percent Complete _ it Should Return Avg Of Rel Fixed And Abs Fixed Cost Of New Vehicle")
    void whenOldVehicleIsNullAndSolutionIs50PercentComplete_itShouldReturnAvgOfRelFixedAndAbsFixedCostOfNewVehicle() {
    ...
    @Test
    @DisplayName("When Old Vehicle Is Null And Solution Is 75 Percent Complete _ it Should Return Avg Of Rel Fixed And Abs Fixed Cost Of New Vehicle")
    void whenOldVehicleIsNullAndSolutionIs75PercentComplete_itShouldReturnAvgOfRelFixedAndAbsFixedCostOfNewVehicle() {
    ...
    @Test
    @DisplayName("When Old Vehicle Is Null And Solution Complete And Weight Is 05 _ it Should Return Half Of Fixed Costs Of New Vehicle")
    void whenOldVehicleIsNullAndSolutionCompleteAndWeightIs05_itShouldReturnHalfOfFixedCostsOfNewVehicle() {
        absFixedCosts.setSolutionCompletenessRatio(1.0);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Null And Solution Is 0 Percent Complete And Weight Is 05 _ it Should Return Half Of No Fixed Costs")
    void whenOldVehicleIsNullAndSolutionIs0PercentCompleteAndWeightIs05_itShouldReturnHalfOfNoFixedCosts() {
        absFixedCosts.setSolutionCompletenessRatio(0.0);
        absFixedCosts.setWeightOfFixCost(.5);
        relFixedCosts.setSolutionCompletenessRatio(0.0);
        relFixedCosts.setWeightOfFixCost(.5);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Null And Solution Is 50 Percent Complete And Weight Is 05 _ it Should Return Half Of Avg Of Rel Fixed And Abs Fixed Cost Of New Vehicle")
    void whenOldVehicleIsNullAndSolutionIs50PercentCompleteAndWeightIs05_itShouldReturnHalfOfAvgOfRelFixedAndAbsFixedCostOfNewVehicle() {
        absFixedCosts.setSolutionCompletenessRatio(0.5);
        absFixedCosts.setWeightOfFixCost(.5);
        relFixedCosts.setSolutionCompletenessRatio(0.5);
        relFixedCosts.setWeightOfFixCost(.5);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Null And Solution Is 75 Percent Complete And Weight Is 05 _ it Should Return Half Of Avg Of Rel Fixed And Abs Fixed Cost Of New Vehicle")
    void whenOldVehicleIsNullAndSolutionIs75PercentCompleteAndWeightIs05_itShouldReturnHalfOfAvgOfRelFixedAndAbsFixedCostOfNewVehicle() {
        absFixedCosts.setSolutionCompletenessRatio(0.75);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Solution Complete _ it Should Return Half Of Fixed Costs Of New Vehicle")
    void whenOldVehicleIsNotNullAndSolutionComplete_itShouldReturnHalfOfFixedCostsOfNewVehicle() {
        absFixedCosts.setSolutionCompletenessRatio(1.0);
        absFixedCosts.setWeightOfFixCost(1.0);
        relFixedCosts.setSolutionCompletenessRatio(1.0);
        relFixedCosts.setWeightOfFixCost(1.0);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Solution Is 0 Percent Complete _ it Should Return No Fixed Costs")
    void whenOldVehicleIsNotNullAndSolutionIs0PercentComplete_itShouldReturnNoFixedCosts() {
        absFixedCosts.setSolutionCompletenessRatio(0.0);
        absFixedCosts.setWeightOfFixCost(1.0);
        relFixedCosts.setSolutionCompletenessRatio(0.0);
        relFixedCosts.setWeightOfFixCost(1.0);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Solution Is 50 Percent Complete _ it Should Correct Val")
    void whenOldVehicleIsNotNullAndSolutionIs50PercentComplete_itShouldCorrectVal() {
        absFixedCosts.setSolutionCompletenessRatio(0.5);
        absFixedCosts.setWeightOfFixCost(1.0);
        relFixedCosts.setSolutionCompletenessRatio(0.5);
        relFixedCosts.setWeightOfFixCost(1.0);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Solution Is 75 Percent Complete _ it Should Return Correct Val")
    void whenOldVehicleIsNotNullAndSolutionIs75PercentComplete_itShouldReturnCorrectVal() {
        absFixedCosts.setSolutionCompletenessRatio(0.75);
        absFixedCosts.setWeightOfFixCost(1.0);
        relFixedCosts.setSolutionCompletenessRatio(0.75);
        relFixedCosts.setWeightOfFixCost(1.0);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Solution Complete And Weight Is 05 _ it Should Return Correct Val")
    void whenOldVehicleIsNotNullAndSolutionCompleteAndWeightIs05_itShouldReturnCorrectVal() {
        absFixedCosts.setSolutionCompletenessRatio(1.0);
        absFixedCosts.setWeightOfFixCost(.5);
        relFixedCosts.setSolutionCompletenessRatio(1.0);
        relFixedCosts.setWeightOfFixCost(.5);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Solution Is 0 Percent Complete And Weight Is 05 _ it Should Return Correct Val")
    void whenOldVehicleIsNotNullAndSolutionIs0PercentCompleteAndWeightIs05_itShouldReturnCorrectVal() {
        absFixedCosts.setSolutionCompletenessRatio(0.0);
        absFixedCosts.setWeightOfFixCost(.5);
        relFixedCosts.setSolutionCompletenessRatio(0.0);
        relFixedCosts.setWeightOfFixCost(.5);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Solution Is 50 Percent Complete And Weight Is 05 _ it Should Return Correct Val")
    void whenOldVehicleIsNotNullAndSolutionIs50PercentCompleteAndWeightIs05_itShouldReturnCorrectVal() {
        absFixedCosts.setSolutionCompletenessRatio(0.5);
        absFixedCosts.setWeightOfFixCost(.5);
        relFixedCosts.setSolutionCompletenessRatio(0.5);
        relFixedCosts.setWeightOfFixCost(.5);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Solution Is 75 Percent Complete And Weight Is 05 _ it Should Return Correct Val")
    void whenOldVehicleIsNotNullAndSolutionIs75PercentCompleteAndWeightIs05_itShouldReturnCorrectVal() {
        absFixedCosts.setSolutionCompletenessRatio(0.75);
        absFixedCosts.setWeightOfFixCost(0.5);
        relFixedCosts.setSolutionCompletenessRatio(0.75);
        relFixedCosts.setWeightOfFixCost(0.5);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Current Load Is 25 And Solution Is 50 Percent Complete And Weight Is 05 _ it Should Return Correct Val")
    void whenOldVehicleIsNotNullAndCurrentLoadIs25AndSolutionIs50PercentCompleteAndWeightIs05_itShouldReturnCorrectVal() {
        absFixedCosts.setSolutionCompletenessRatio(0.5);
        absFixedCosts.setWeightOfFixCost(.5);
        relFixedCosts.setSolutionCompletenessRatio(0.5);
        relFixedCosts.setWeightOfFixCost(.5);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Current Load Is 25 And Solution Is 75 Percent Complete And Weight Is 05 _ it Should Return Correct Val")
    void whenOldVehicleIsNotNullAndCurrentLoadIs25AndSolutionIs75PercentCompleteAndWeightIs05_itShouldReturnCorrectVal() {
        absFixedCosts.setSolutionCompletenessRatio(0.75);
        absFixedCosts.setWeightOfFixCost(0.5);
        relFixedCosts.setSolutionCompletenessRatio(0.75);
        relFixedCosts.setWeightOfFixCost(0.5);
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Current Load Is 25 And Solution Is 50 Percent Complete And Weight Is 05 With Multiple Cap Dims _ it Should Return Correct Val")
    void whenOldVehicleIsNotNullAndCurrentLoadIs25AndSolutionIs50PercentCompleteAndWeightIs05WithMultipleCapDims_itShouldReturnCorrectVal() {
    ...
    @Test
    @DisplayName("When Old Vehicle Is More Expensive")
    void whenOldVehicleIsMoreExpensive() {
    ...
    @Test
    @DisplayName("Small VS Medium Abs Costs")
    void smallVSMediumAbsCosts() {
        absFixedCosts.setSolutionCompletenessRatio(1);
        absFixedCosts.setWeightOfFixCost(1);
        relFixedCosts.setSolutionCompletenessRatio(1);
        relFixedCosts.setWeightOfFixCost(1);
    ...
    @Test
    @DisplayName("Small VS Large Abs Costs")
    void smallVSLargeAbsCosts() {
        absFixedCosts.setSolutionCompletenessRatio(1);
        absFixedCosts.setWeightOfFixCost(1);
        relFixedCosts.setSolutionCompletenessRatio(1);
        relFixedCosts.setWeightOfFixCost(1);
    ...
    @Test
    @DisplayName("Large VS Medium Abs Costs")
    void largeVSMediumAbsCosts() {
        absFixedCosts.setSolutionCompletenessRatio(1);
        absFixedCosts.setWeightOfFixCost(1);
        relFixedCosts.setSolutionCompletenessRatio(1);
        relFixedCosts.setWeightOfFixCost(1);
    ...
    @Test
    @DisplayName("Medium VS Large Abs Costs")
    void mediumVSLargeAbsCosts() {
        absFixedCosts.setSolutionCompletenessRatio(1);
        absFixedCosts.setWeightOfFixCost(1);
        relFixedCosts.setSolutionCompletenessRatio(1);
        relFixedCosts.setWeightOfFixCost(1);
    ...
    @Test
    @DisplayName("When Old Vehicle Is More Expensive 2")
    void whenOldVehicleIsMoreExpensive2() {
    ...
    @Test
    @DisplayName("When Old Vehicle Is Not Null And Current Load Is 25 And Solution Is 75 Percent Complete And Weight Is 05 With Multiple Cap Dims _ it Should Return Correct Val")
    void whenOldVehicleIsNotNullAndCurrentLoadIs25AndSolutionIs75PercentCompleteAndWeightIs05WithMultipleCapDims_itShouldReturnCorrectVal() {
        absFixedCosts.setSolutionCompletenessRatio(0.75);
        absFixedCosts.setWeightOfFixCost(0.5);
        relFixedCosts.setSolutionCompletenessRatio(0.75);
        relFixedCosts.setWeightOfFixCost(0.5);
