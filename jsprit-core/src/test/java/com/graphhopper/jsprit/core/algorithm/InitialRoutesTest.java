...
class InitialRoutesTest {
    ...
    @Test
    @DisplayName("When Solving _ nu Jobs In Solution Should Be 2")
    void whenSolving_nuJobsInSolutionShouldBe2() {
    ...
    @Test
    @DisplayName("When Solving _ nu Acts Should Be 2")
    void whenSolving_nuActsShouldBe2() {
    ...
    @Test
    @DisplayName("When Solving _ deliver Service 1 _ should Be In Route")
    void whenSolving_deliverService1_shouldBeInRoute() {
        VehicleRoutingAlgorithm vra = new SchrimpfFactory().createAlgorithm(vrp);
        Collection<VehicleRoutingProblemSolution> solutions = vra.searchSolutions();
        VehicleRoutingProblemSolution solution = Solutions.bestOf(solutions);
    ...
    @Test
    @DisplayName("When Solving _ deliver Service 2 _ should Be In Route")
    void whenSolving_deliverService2_shouldBeInRoute() {
        VehicleRoutingAlgorithm vra = new SchrimpfFactory().createAlgorithm(vrp);
        Collection<VehicleRoutingProblemSolution> solutions = vra.searchSolutions();
        VehicleRoutingProblemSolution solution = Solutions.bestOf(solutions);
    ...
    @Test
    @DisplayName("Max Capacity Should Not Be Exceeded")
    void maxCapacityShouldNotBeExceeded() {
        ...
        Shipment shipment =
                Shipment.Builder
                        .newInstance("s")
                        .setPickupLocation(PickupLocation.Builder.newInstance().setLocation(Location.Builder.newInstance().setCoordinate(Coordinate.newInstance(10, 0)).setId("pick").build()).build())
    ...
    @Test
    @DisplayName("When All Jobs In Initial Route _ it Should Work")
    void whenAllJobsInInitialRoute_itShouldWork() {
    ...
    @Test
    @DisplayName("Build Without Time Constraints")
    void buildWithoutTimeConstraints() {
