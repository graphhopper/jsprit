 ...
 * @author schroeder
 */
public class EnRoutePickup extends Service {

    public static class Builder extends Service.Builder<EnRoutePickup> {
...
//            return this;
         ...
         */
        public EnRoutePickup build() {
            if (location == null) throw new IllegalArgumentException("location is missing");
            this.setType("en-route-pickup");
            super.capacity = super.capacityBuilder.build();
            super.skills = super.skillBuilder.build();
            super.activity = new Activity.Builder(location, Activity.Type.EN_ROUTE_PICKUP).setTimeWindows(timeWindows.getTimeWindows()).setServiceTime(serviceTime).build();
            return new EnRoutePickup(this);
        }

    }

    EnRoutePickup(Builder builder) {
        super(builder);
    }

    public Type getJobType() {
        return Type.EN_ROUTE_PICKUP;
    }
