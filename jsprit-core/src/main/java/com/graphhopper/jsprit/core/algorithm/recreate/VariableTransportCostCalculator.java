...
public class VariableTransportCostCalculator implements SoftActivityConstraint {
    ...
    public double getCosts(JobInsertionContext iFacts, TourActivity prevAct, TourActivity newAct, TourActivity nextAct, double depTimeAtPrevAct) {
    	...
    	double setup_costs_prevAct_newAct = setup_time_prevAct_newAct * iFacts.getNewVehicle().getType().getVehicleCostParams().perSetupTimeUnit;
        ...
        double setup_costs_newAct_nextAct = setup_time_newAct_nextAct * iFacts.getNewVehicle().getType().getVehicleCostParams().perSetupTimeUnit;
        ...
        if (iFacts.getRoute().isEmpty()) {
            ...
            double setup_costs_prevAct_nextAct = setup_time_prevAct_nextAct * iFacts.getNewVehicle().getType().getVehicleCostParams().perSetupTimeUnit;
